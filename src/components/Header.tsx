...
import { User, LogOut, ChevronDown, Phone } from "lucide-react";
                    ...
                    <nav className="hidden md:flex space-x-8">
                        ...
                        >
                            <button
                                ...
                                className="text-gray-700 hover:text-yellow-600 transition-colors font-medium flex items-center gap-1"
                            >
                                Каталог
