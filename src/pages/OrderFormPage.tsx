                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                                    ...
                                    >
                                        <div>
                                            ...
                                            <div className="text-gray-600">
                                                {item.quantity} {item.product.unit} × {item.product.price_per_sqm} ₽
                                            </div>
                                        </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                ...
                                <div className="col-span-2 border-t border-amber-300 pt-4 mt-2">
                                    ...
                                    <p className="text-2xl font-bold text-amber-600">
                                        {orderData.totalCost.toLocaleString("ru-RU")} ₽
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-amber-50 text-amber-700 border border-amber-400 py-4 rounded-lg hover:bg-amber-100 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed text-lg font-semibold"
                        >
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full flex items-center justify-center space-x-2 bg-gray-100 text-gray-800 py-3 rounded-lg hover:bg-gray-200 transition-colors disabled:bg-gray-200 disabled:cursor-not-allowed font-semibold"
                        >
