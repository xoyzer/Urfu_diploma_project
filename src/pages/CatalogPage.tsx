        ...
        <div className="min-h-screen bg-gray-50 py-6 sm:py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-6 sm:mb-8">
                    <h1 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-2 sm:mb-4">Каталог продукции</h1>
                ...
                <button
                    ...
                    className="md:hidden w-full flex items-center justify-center gap-2 bg-yellow-600 text-white py-3 rounded-lg font-semibold mb-4"
                >
                ...
                <div className="flex gap-8 items-start">
                    ...
                    <div className="flex-1 min-w-0">
                        {/* Sort + count bar */}
                        <div className="flex items-center justify-between mb-4 gap-2 sm:gap-4 flex-wrap">
...
interface FilterContentProps {
    ...
    setAvailabilityFilter: React.Dispatch<React.SetStateAction<Set<string>>>;
    ...
    setSelectedPurposes: React.Dispatch<React.SetStateAction<Set<string>>>;
    priceMin: string;
    ...
    resetFilters: () => void;
    toggleSet: <T>(set: Set<T>, value: T) => Set<T>;
}
...
function ProductCard({ product, onNavigate }: { product: Product; onNavigate: (page: string) => void }) {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
            <div className="h-36 sm:h-48 bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                {product.photo_url ? (
