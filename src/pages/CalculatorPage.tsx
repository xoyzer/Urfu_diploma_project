                ...
                <div className="bg-white rounded-lg shadow-lg p-5 sm:p-8">
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        ...
                        {!isPickup && items.length > 0 && (
                            <div className="bg-yellow-0 border-2 border-yellow-100 rounded-lg p-4 sm:p-6">
                                ...
                                {fleet.length === 0 ? (
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-2">
                                            {fleet.map((v, idx) => (
                                                <div key={idx} className="flex items-baseline justify-between bg-white rounded-lg p-3 border border-yellow-200">
                                                    <div>
