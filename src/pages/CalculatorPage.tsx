...
import { Calculator, Truck, MapPin, ShoppingCart, Plus, Trash2, Search, Loader as Loader2, Info } from "lucide-react";
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white rounded-lg shadow-lg p-5 sm:p-8">
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        ...
                        <div className="bg-yellow-50/50 p-4 sm:p-6 rounded-lg border-2 border-yellow-600/50">
