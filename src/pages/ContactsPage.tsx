                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-4 justify-center lg:justify-start mt-6 mb-6">
                                            <a
                                                ...
                                                className="flex items-center justify-center w-16 h-16 rounded-full bg-gray-100 border border-gray-400 text-[#0088cc] hover:bg-[#0088cc] hover:text-white hover:border-[#0088cc] transition-all duration-300"
                                                title="Telegram"
                                            >
                                            ...
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="flex items-center justify-center w-16 h-16 rounded-full bg-gray-100 border border-gray-400 text-[#25D366] hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all duration-300"
                                                title="WhatsApp"
                                            >
                                                <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
                                            ...
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="flex items-center justify-center w-16 h-16 rounded-full bg-gray-100 border border-gray-400 text-[#505ff3] hover:bg-[#505ff3] hover:text-white hover:border-[#505ff3] transition-all duration-300"
                                                title="Max"
                                            >
