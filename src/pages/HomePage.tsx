                        ...
                        <div className="text-center lg:text-left">
                            ...
                            <div className="flex gap-4 justify-center lg:justify-start mt-6">
                                <a
                                    ...
                                    className="flex items-center justify-center w-12 h-12 rounded-full bg-white/10 border border-white/20 text-white hover:bg-[#0088cc] hover:border-[#0088cc] transition-all duration-300"
                                    title="Telegram"
                                >
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center justify-center w-12 h-12 rounded-full bg-white/10 border border-white/20 text-white hover:bg-[#25D366] hover:border-[#25D366] transition-all duration-300"
                                    title="WhatsApp"
                                >
                                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
